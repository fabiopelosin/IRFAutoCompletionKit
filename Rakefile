...
task :spec do
  sh("xctool -workspace Project/IRFAutoCompletionKit.xcworkspace -scheme Demo test")
end
...
#
# @note   It is computed by bumping the last component of the version string by
#         1.
#
...
#
# @note   This methods replaces the version number in the podspec file with a
#         new version number.
#
# @return void
#
